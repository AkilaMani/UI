...
class HeaderGame extends StatefulWidget {
  const HeaderGame({Key? key}) : super(key: key);

  @override
  _HeaderGameState createState() => _HeaderGameState();
}

class _HeaderGameState extends State<HeaderGame> {
  @override
